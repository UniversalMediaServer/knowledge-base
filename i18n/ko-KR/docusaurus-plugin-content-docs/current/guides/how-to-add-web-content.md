...
![공유 콘텐츠 목록 및 주문 기능] ([img/웹 콘텐츠 추가 방법-3-이름-이름-및-sort.png])
...
![웹 플레이어의 비디오 피드 예] ([img/웹 컨텐츠 추가 방법-4-feed-player.png])
