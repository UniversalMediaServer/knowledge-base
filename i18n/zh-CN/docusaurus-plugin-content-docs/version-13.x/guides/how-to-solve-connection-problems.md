...
This usually happens when your computer has more than one active network connection (for example, one wired and one wireless). You can solve it by setting which network interface you want: You can solve it by setting which network interface you want: You can solve it by setting which network interface you want: You can solve it by setting which network interface you want:
