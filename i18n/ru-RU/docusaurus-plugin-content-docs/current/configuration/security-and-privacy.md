...
![Пример присвоения учетной записи рендеру](@site/docs/img/whats-new-in-v14-assign-account-to-renderer.png)
...
![Пример групп общего доступа к контенту](@site/docs/img/whats-new-in-v14-shared-content-group.png)
